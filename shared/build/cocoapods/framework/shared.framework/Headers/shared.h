...
*/
- (void)greetingWithCompletionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("greeting(completionHandler:)")));
@end;
...
- (SharedHello *)doCopyString:(NSString *)string __attribute__((swift_name("doCopy(string:)")));
...
@interface SharedHelloCompanion : SharedBase
...
+ (SharedKtor_client_coreHttpClient *)httpClientConfig:(void (^)(SharedKtor_client_coreHttpClientConfig<id> *))config __attribute__((swift_name("httpClient(config:)")));
